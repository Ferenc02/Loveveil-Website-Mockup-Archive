<svelte:head>
	<title>LoveVeil Privacy Policy: Your Data, Your Security</title>
	<meta
		name="description"
		content="Explore LoveVeil's Privacy Policy to learn how we safeguard your data and prioritize your privacy on our platform. Your trust is our priority"
	/>
</svelte:head>

<div
	class="xl:w-[60%] md:w-[65%] w-[80%] mx-auto max-w-[900px] text-secondary-content xl:text-xl md:text-lg text-base"
>
	<p class="xl:text-3xl md:text-2xl text-xl font-bold">Privacy Policy</p>
	<p>
		At LoveVeil website, accessible from loveveil.netlify.app, one of our main priorities is the
		privacy of our visitors. This Privacy Policy document contains types of information that is
		collected and recorded by LoveVeil website and how we use it.
	</p>
	<br />
	<p>
	...
	<p>
		...
		website with regards to the information that they shared and/or collect in LoveVeil website.
		This policy is not applicable to any information collected offline or via channels other than
		this website.
	</p>
	<br />
	<p class="xl:text-3xl md:text-2xl text-xl font-bold">Consent</p>
	<p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>
	<br />
	<p class="xl:text-3xl md:text-2xl text-xl font-bold">Information we collect</p>
	<p>
	...
	<br />
	<p class="xl:text-3xl md:text-2xl text-xl font-bold">How we use your information</p>
	...
	<br />
	<p class="xl:text-3xl md:text-2xl text-xl font-bold">Log Files</p>
	<p>
		LoveVeil website follows a standard procedure of using log files. These files log visitors when
		...
		Internet Service Provider (ISP), date and time stamp. These are not linked to any information
		that is personally identifiable. The purpose of the information is for analyzing trends, and
		administering the site.
	</p>
	<br />
	<p class="xl:text-3xl md:text-2xl text-xl font-bold">Advertising Partners Privacy Policies</p>
	<p>
	...
	<p>
		...
		that are used in their respective advertisements and links that appear on LoveVeil website,
	...
	<p>
		Note that LoveVeil website has no access to or control over these cookies that are used by
		third-party advertisers.
	</p>
	<br />
	<p class="xl:text-3xl md:text-2xl text-xl font-bold">Third Party Privacy Policies</p>
	<p>
		LoveVeil website's Privacy Policy does not apply to other advertisers or websites. Thus, we are
	...
	<br />
	<p class="xl:text-3xl md:text-2xl text-xl font-bold">
	...
	<br />
	<p class="xl:text-3xl md:text-2xl text-xl font-bold">GDPR Data Protection Rights</p>
	<p>
	...
	<br />
	<p class="xl:text-3xl md:text-2xl text-xl font-bold">Children's Information</p>
	<p>
	...
	<p>
		LoveVeil website does not knowingly collect any Personal Identifiable Information from children
		under the age of 13. If you think that your child provided this kind of information on our
		website, we strongly encourage you to <a
			href="mailto:email@placeholder.com"
			class="underline"
			target="_blank"
			rel="noopener noreferrer">contact us</a
	...
	<br />
	<p class="xl:text-3xl md:text-2xl text-xl font-bold">Changes to This Privacy Policy</p>
	<p>
	...
	<br />
	<p class="xl:text-3xl md:text-2xl text-xl font-bold">Contact Us</p>
	<p>
